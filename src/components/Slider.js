...
export default class SlickSlider extends Component {
    ...
    render() {
        ...
        const hStyles = [
            { color: '#333', fontSize: '38px', fontWeight: '500', zIndex: '5', paddingBottom: '12px' },
            { color: '#eee', fontSize: '38px', fontWeight: '500', zIndex: '5', paddingBottom: '12px' },
            { color: '#798691', fontSize: '33px', fontWeight: '1000', zIndex: '5', paddingBottom: '12px' },
            { color: '#333', fontSize: '38px', fontWeight: '900', zIndex: '5', paddingBottom: '12px' },
            { marginTop: '9rem', marginLeft: '40rem', fontSize: '35px', fontWeight: '700' }
        ]
        const liStyle = {
                ...
                Elements:
                    <div>
                        ...
                        <li style={liStyle}>
                            ...
                            <p style={pStyles[0]}>ㆍ<b style={{fontWeight: '500'}}>AMD Ryzen</b> 쿼드코어 <b style={{fontWeight: '400'}}>656 MBps</b> 2.2GHz</p>
                            <p style={pStyles[0]}>ㆍ<b style={{fontWeight: '500'}}>4GB DDR4</b> 메모리(최대 32GB까지 확장 가능)</p>
                            <p style={pStyles[0]}>ㆍSynology DX517 확장유닛으로 </p>
                            <p style={pStyles[0]}><b style={{fontWeight: '500'}}>최대 18Bay</b>확장 가능</p>
                ...
                Elements:
                    <div>
                        <li style={liStyle}>
                            ...
                            <p style={pStyles[1]}>ㆍ대역폭 집약 환경을 위해 기본 제공되는 10GBASE-T</p>
            ...
            },
            {
                ...
                Elements:
                    <div>
                        ...
                        <img style={{position: 'relative', left: '70rem', bottom: '10rem'}} src="https://www.ablestor.com/public/image/slider/Slider_14_logo.png" alt="synology"></img>
                        <img style={{position: 'relative', bottom: '8rem', left: '28rem'}} src="https://www.ablestor.com/public/image/slider/Slider_new_product.png" alt="DS1821+"></img>
                        <span style={{position: 'relative', left: '40rem', bottom: '23rem'}}>
                            <Button style={{height: '2rem', fontSize: '14px'}} variant="outline-secondary" size="sm">DS920+</Button>
                            <Button style={{marginLeft: '12rem', height: '2rem', fontSize: '14px'}} variant="outline-secondary" size="sm">DS420+</Button>
                            <Button style={{marginLeft: '10rem', fontSize: '14px'}} variant="outline-secondary" size="sm">DS220+</Button>
                        </span>
                    </div>
            },
            {
                ...
                Elements:
                    <div>
                        <li style={liStyle}>
                            ...
                            <p style={pStyles[3]}>ㆍ저장소를 확장할 수 있는 고성능 랙 마운트 4베이 NAS</p>
                            <p style={pStyles[3]}>ㆍ쿼드 코어 CPU 및 8GB DDR4 UDIMM(64베이까지 확장 가능)</p>
                            <p style={pStyles[3]}>ㆍNVMe/SATA SSD 캐시를 지원하는 이중 M.2 2280 슬롯</p>
                ...
                Elements:
                    <div>
                        <li style={{marginLeft: '300px', marginTop: '110px'}}>
                            ...
                            <p style={pStyles[4]}>가상화, 데이터 집중 응용 프로그램 및 지속적인 서비스를 위해</p>
